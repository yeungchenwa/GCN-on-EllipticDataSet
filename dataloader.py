...
def EllipticDataSet_Loader(data_dir, start_ts, end_ts):
	...
	print('Total transactions number in Elliptic Data Set is {:d}'.format(len(list(classes.index))))
	...
	for ts in range(start_ts, end_ts):
	    ...
	    print("Loading train Elliptic Dataset time step %d"%(ts+1))
...
# adj_mats, features_labelled_ts, classes_ts = load_data('F:/test/elliptic_bitcoin_dataset', 0, 33)
